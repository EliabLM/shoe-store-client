...
import { CATEGORY_ENUM_NAMES, createCategorySchema } from './categorySchema';
...
const NewCategory = () => {
  ...
  const { createCategory } = useCategoriesService();
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (
        !validateResponse(
          response,
          'Ha ocurrido un error registrando la categoría, por favor intente nuevamente.'
        )
      )
        return;
